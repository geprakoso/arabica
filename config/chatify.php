...
return [
    ...
    |-------------------------------------
    */
    'name' => env('CHATIFY_NAME', 'Chat Room'),
    ...
    */
    'pusher' => [
        ...
        // Provide safe defaults to avoid type errors if env vars are missing;
        // replace with your real Pusher credentials in .env.
        'key' => env('PUSHER_APP_KEY', 'local-pusher-key'),
        'secret' => env('PUSHER_APP_SECRET', 'local-pusher-secret'),
        'app_id' => env('PUSHER_APP_ID', 'local-pusher-app'),
        'options' => [
