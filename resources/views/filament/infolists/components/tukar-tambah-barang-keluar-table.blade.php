                        ...
                        <div class="flex items-center justify-center gap-2">
                            @if($produkId)
                                <a href="{{ route('filament.admin.resources.master-data.produks.view', ['record' => $produkId]) }}" 
                                   target="_blank"
                                   class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-warning-600 hover:bg-gray-100 dark:hover:bg-gray-100 transition hover:scale-110"
                                   title="Lihat Produk">
                                    <x-heroicon-m-eye class="w-4 h-4" />
                                </a>
                                <a href="{{ route('filament.admin.resources.master-data.produks.edit', ['record' => $produkId]) }}" 
                                   target="_blank"
                                   class="inline-flex items-center justify-center w-8 h-8 rounded-lg text-primary-600 hover:bg-gray-100 dark:hover:bg-gray-100 transition hover:scale-110"
                                   title="Edit Produk">
